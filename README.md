...
# Custom MVC Framework using PHP (My Starter Template)
> **Note:** This repository contains the core code of my custom MVC Framework ( my starter template ) by following MVC pattern inspired by PHP framework's CodeIgniter. 
...
## About The Project
Model–view–controller is a software design pattern commonly used for developing user interfaces which divides the related program logic into three interconnected elements. This is done to separate internal representations of information from the ways information is presented to and accepted from the user. In this project, I have made my own Custom MVC Framwork ( my starter template ) by following MVC pattern using PHP, OOP, MySQL inspired by CodeIgniter.
...
1. Clone the repo
```sh
git remote add origin https://github.com/Masud99Rana/Custom-MR-MVC-Framework_PHP.git
```
